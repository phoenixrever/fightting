        ...
        <div class="theme-panel-content">
            ...
            <ul class="theme-list clearfix">
                <li><a href="javascript:;" class="bg-green" data-theme="green"
                       data-theme-file={{ asset("admin_doc/assets/css/transparent/theme/green.css") }} data-click="theme-selector"
                ...
                <li><a href="javascript:;" class="bg-red" data-theme="red"
                       data-theme-file={{ asset("admin_doc/assets/css/transparent/theme/red.css") }} data-click="theme-selector"
                ...
                <li class="active"><a href="javascript:;" class="bg-blue" data-theme="default"
                                      data-theme-file={{ asset("admin_doc/assets/css/transparent/theme/default.css") }}
                ...
                <li><a href="javascript:;" class="bg-purple" data-theme="purple"
                       data-theme-file={{ asset("admin_doc/assets/css/transparent/theme/purple.css") }} data-click="theme-selector"
                       data-toggle="tooltip" data-trigger="hover" data-container="body"
                       data-title="Purple">&nbsp;</a></li>
                <li><a href="javascript:;" class="bg-orange" data-theme="orange"
                       data-theme-file={{ asset("admin_doc/assets/css/transparent/theme/orange.css") }}data-click="theme-selector"
                       data-toggle="tooltip" data-trigger="hover" data-container="body"
                       data-title="Orange">&nbsp;</a></li>
                <li><a href="javascript:;" class="bg-black" data-theme="black"
                       data-theme-file={{ asset("admin_doc/assets/css/transparent/theme/black.css") }} data-click="theme-selector"
                       data-toggle="tooltip" data-trigger="hover" data-container="body"
