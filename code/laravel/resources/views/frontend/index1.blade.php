...
<head>
    ...
    <link href="/frontend_assets/plugins/bootstrap3/css/bootstrap.min.css" rel="stylesheet" />
    {{--<link href={{asset("assets/css/bundle.css")}} rel="stylesheet" />--}}
    <link href="/frontend_assets/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
    <link href="/frontend_assets/plugins/animate/animate.min.css" rel="stylesheet" />
    <link href="/frontend_assets/css/e-commerce/style.css" rel="stylesheet" />
    <link href="/frontend_assets/css/e-commerce/style-responsive.min.css" rel="stylesheet" />
    <link href="/frontend_assets/css/e-commerce/theme/default.css" id="theme" rel="stylesheet" />
    <!-- ================== END BASE CSS STYLE ================== -->

    <!-- ================== BEGIN BASE JS ================== -->
    <script src="/frontend_assets/plugins/pace/pace.min.js"></script>
    <!-- ================== END BASE JS ================== -->
</head>
<body>
                                    ...
                                    <div class="dropdown-menu-container">
                                        ...
                                        <div class="dropdown-menu-content">
                                            ...
                                            <ul class="dropdown-brand-list m-b-0">
                                                <li><a href="product.html"><img src="/frontend_assets/img/brand/brand-apple.png" alt="" /></a></li>
                                                <li><a href="product.html"><img src="/frontend_assets/img/brand/brand-samsung.png" alt="" /></a></li>
                                                <li><a href="product.html"><img src="/frontend_assets/img/brand/brand-htc.png" alt="" /></a></li>
                                                <li><a href="product.html"><img src="/frontend_assets/img/brand/brand-microsoft.png" alt="" /></a></li>
                                                <li><a href="product.html"><img src="/frontend_assets/img/brand/brand-nokia.png" alt="" /></a></li>
                                                <li><a href="product.html"><img src="/frontend_assets/img/brand/brand-blackberry.png" alt="" /></a></li>
                                                <li><a href="product.html"><img src="/frontend_assets/img/brand/brand-sony.png" alt="" /></a></li>
                                            </ul>
                                        </div>
                    ...
                    <ul class="nav pull-right">
                        <li class="dropdown dropdown-hover">
                            ...
                            <div class="dropdown-menu dropdown-menu-cart p-0">
                                ...
                                <div class="cart-body">
                                    <ul class="cart-item">
                                        <li>
                                            <div class="cart-item-image"><img src="/frontend_assets/img/product/product-ipad.jpg" alt="" /></div>
                                        ...
                                        <li>
                                            <div class="cart-item-image"><img src="/frontend_assets/img/product/product-imac.jpg" alt="" /></div>
                                            <div class="cart-item-info">
                                        ...
                                        <li>
                                            <div class="cart-item-image"><img src="/frontend_assets/img/product/product-iphone.png" alt="" /></div>
                                            <div class="cart-item-info">
                        ...
                        <li>
                            <a href="my_account.html">
                                <img src="/frontend_assets/img/user/user-1.jpg" class="user-img" alt="" />
        ...
        <div id="main-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active">
                    <img src="/frontend_assets/img/slider/slider-1-cover.jpg" class="bg-cover-img" alt="" />
                    <div class="container">
                        <img src="/frontend_assets/img/slider/slider-1-product.png" class="product-img right bottom fadeInRight animated" alt="" />
                    </div>
                ...
                <!-- BEGIN item -->
                <div class="item">
                    <img src="/frontend_assets/img/slider/slider-2-cover.jpg" class="bg-cover-img" alt="" />
                    <div class="container">
                        <img src="/frontend_assets/img/slider/slider-2-product.png" class="product-img left bottom fadeInLeft animated" alt="" />
                    </div>
                ...
                <!-- BEGIN item -->
                <div class="item">
                    <img src="/frontend_assets/img/slider/slider-3-cover.jpg" class="bg-cover-img" alt="" />
                ...
                <div class="col-md-6">
                    ...
                    <div class="promotion promotion-lg bg-black-darker">
                        <div class="promotion-image text-right promotion-image-overflow-bottom">
                            <img src="/frontend_assets/img/product/product-iphone-se.png" alt="" />
                        </div>
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="promotion bg-blue">
                        <div class="promotion-image promotion-image-overflow-bottom promotion-image-overflow-top">
                            <img src="/frontend_assets/img/product/product-apple-watch-sm.png" alt="" />
                        </div>
                    ...
                    <div class="promotion bg-silver">
                        <div class="promotion-image text-center promotion-image-overflow-bottom">
                            <img src="/frontend_assets/img/product/product-mac-mini.png" alt="" />
                        </div>
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="promotion bg-silver">
                        <div class="promotion-image promotion-image-overflow-right promotion-image-overflow-bottom text-right">
                            <img src="/frontend_assets/img/product/product-mac-accessories.png" alt="" />
                        </div>
                        <div class="promotion-caption text-center">
                    ...
                    <div class="promotion bg-black">
                        <div class="promotion-image text-right">
                            <img src="/frontend_assets/img/product/product-mac-pro.png" alt="" />
                        </div>
                        <div class="promotion-caption promotion-caption-inverse">
        ...
        <div class="container">
            ...
            <div class="row row-space-10">
                ...
                <div class="col-md-2 col-sm-4">
                    ...
                    <div class="item item-thumbnail">
                        <a href="product_detail.html" class="item-image">
                            <img src="/frontend_assets/img/product/product-iphone.png" alt="" />
                ...
                <div class="col-md-2 col-sm-4">
                    ...
                    <div class="item item-thumbnail">
                        <a href="product_detail.html" class="item-image">
                            <img src="/frontend_assets/img/product/product-ipad-pro.png" alt=""  />
                ...
                <div class="col-md-2 col-sm-4">
                    ...
                    <div class="item item-thumbnail">
                        <a href="product_detail.html" class="item-image">
                            <img src="/frontend_assets/img/product/product-imac.png" alt="" />
                ...
                <div class="col-md-2 col-sm-4">
                    ...
                    <div class="item item-thumbnail">
                        <a href="product_detail.html" class="item-image">
                            <img src="/frontend_assets/img/product/product-apple-watch.png" alt="" />
                ...
                <div class="col-md-2 col-sm-4">
                    ...
                    <div class="item item-thumbnail">
                        <a href="product_detail.html" class="item-image">
                            <img src="/frontend_assets/img/product/product-macbook-pro.png" alt="" />
                ...
                <div class="col-md-2 col-sm-4">
                    ...
                    <div class="item item-thumbnail">
                        <a href="product_detail.html" class="item-image">
                            <img src="/frontend_assets/img/product/product-apple-tv.png" alt="" />
                ...
                <div class="category-detail">
                    ...
                    <a href="#" class="category-item full">
                        <div class="item">
                            <div class="item-cover">
                                <img src="/frontend_assets/img/product/product-samsung-s7-edge.jpg" alt="" />
                            </div>
                    ...
                    <div class="category-item list">
                        ...
                        <div class="item-row">
                            ...
                            <div class="item item-thumbnail">
                                <a href="product_detail.html" class="item-image">
                                    <img src="/frontend_assets/img/product/product-samsung-note5.png" alt="" />
                                    <div class="discount">32% OFF</div>
                                </a>
                                <div class="item-info">
                                    <h4 class="item-title">
                        ...
                        <div class="item-row">
                            ...
                            <div class="item item-thumbnail">
                                <a href="product_detail.html" class="item-image">
                                    <img src="/frontend_assets/img/product/product-zenfone2.png" alt="" />
                                    <div class="discount">15% OFF</div>
                                </a>
                                <div class="item-info">
                                    <h4 class="item-title">
                            ...
                            <div class="item item-thumbnail">
                                <a href="product_detail.html" class="item-image">
                                    <img src="/frontend_assets/img/product/product-xperia-z.png" alt="" />
                                    <div class="discount">32% OFF</div>
                                </a>
                                <div class="item-info">
                                    <h4 class="item-title">
                            ...
                            <div class="item item-thumbnail">
                                <a href="product_detail.html" class="item-image">
                                    <img src="/frontend_assets/img/product/product-lumia-532.png" alt="" />
                                    <div class="discount">20% OFF</div>
                                </a>
                                <div class="item-info">
                                    <h4 class="item-title">
            ...
            <div class="category-container">
                ...
                <div class="category-detail">
                    ...
                    <a href="#" class="category-item full">
                        <div class="item">
                            <div class="item-cover">
                                <img src="/frontend_assets/img/product/product-huawei-mediapad.jpg" alt="" />
                            </div>
                            <div class="item-info bottom">
                    ...
                    <div class="category-item list">
                        ...
                        <div class="item-row">
                            ...
                            <div class="item item-thumbnail">
                                <a href="product_detail.html" class="item-image">
                                    <img src="/frontend_assets/img/product/product-galaxy-tab2.png" alt="" />
                                    <div class="discount">32% OFF</div>
                                </a>
                                <div class="item-info">
                                    <h4 class="item-title">
                            ...
                            <div class="item item-thumbnail">
                                <a href="product_detail.html" class="item-image">
                                    <img src="/frontend_assets/img/product/product-galaxy-taba.png" alt="" />
                                    <div class="discount">20% OFF</div>
                                </a>
                                <div class="item-info">
                                    <h4 class="item-title">
                        ...
                        <div class="item-row">
                            ...
                            <div class="item item-thumbnail">
                                <a href="product_detail.html" class="item-image">
                                    <img src="/frontend_assets/img/product/product-hp-spectrex2.png" alt="" />
                                    <div class="discount">15% OFF</div>
                                </a>
                                <div class="item-info">
                                    <h4 class="item-title">
                            ...
                            <div class="item item-thumbnail">
                                <a href="product_detail.html" class="item-image">
                                    <img src="/frontend_assets/img/product/product-xperia-z2.png" alt="" />
                                    <div class="discount">32% OFF</div>
                                </a>
                                <div class="item-info">
                                    <h4 class="item-title">
                            ...
                            <div class="item item-thumbnail">
                                <a href="product_detail.html" class="item-image">
                                    <img src="/frontend_assets/img/product/product-ipad-air.png" alt="" />
                                    <div class="discount">20% OFF</div>
                                </a>
                                <div class="item-info">
                                    <h4 class="item-title">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled list-product">
                        <li>
                            <div class="image">
                                <img src="/frontend_assets/img/product/product-iphone-6s.jpg" alt="" />
                            </div>
                            <div class="info">
                        ...
                        <li>
                            <div class="image">
                                <img src="/frontend_assets/img/product/product-galaxy-s6.jpg" alt="" />
                            </div>
                            <div class="info">
                        ...
                        <li>
                            <div class="image">
                                <img src="/frontend_assets/img/product/product-ipad-pro.jpg" alt="" />
                            </div>
                            <div class="info">
                        ...
                        <li>
                            <div class="image">
                                <img src="/frontend_assets/img/product/product-galaxy-note5.jpg" alt="" />
                            </div>
                            <div class="info">
    ...
    <div id="footer-copyright" class="footer-copyright">
        ...
        <div class="container">
            <div class="payment-method">
                <img src="/frontend_assets/img/payment/payment-method.png" alt="" />
            </div>
            <div class="copyright">
...
<div class="theme-panel">
    ...
    <div class="theme-panel-content">
        <ul class="theme-list clearfix">
            <li><a href="javascript:;" class="bg-purple" data-theme="purple" data-theme-file="/frontend_assets/css/e-commerce/theme/purple.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Purple">&nbsp;</a></li>
            <li><a href="javascript:;" class="bg-blue" data-theme="blue" data-theme-file="/frontend_assets/css/e-commerce/theme/blue.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Blue">&nbsp;</a></li>
            <li class="active"><a href="javascript:;" class="bg-green" data-theme-file="/frontend_assets/css/e-commerce/theme/default.css" data-theme="default" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Default">&nbsp;</a></li>
            <li><a href="javascript:;" class="bg-orange" data-theme="orange" data-theme-file="/frontend_assets/css/e-commerce/theme/orange.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Orange">&nbsp;</a></li>
            <li><a href="javascript:;" class="bg-red" data-theme="red" data-theme-file="/frontend_assets/css/e-commerce/theme/red.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Red">&nbsp;</a></li>
        </ul>
    </div>
</div>
<!-- end theme-panel -->
...
<!-- ================== BEGIN BASE JS ================== -->
{{--<script src="/frontend_assets/plugins/jquery/jquery-3.2.1.min.js"></script>--}}
<script src={{asset("assets/js/bundle.js")}}></script>
{{--<script src="/frontend_assets/plugins/bootstrap3/js/bootstrap.min.js"></script>--}}
<!--[if lt IE 9]>
    <script src="/frontend_assets/crossbrowserjs/html5shiv.js"></script>
    <script src="/frontend_assets/crossbrowserjs/respond.min.js"></script>
    <script src="/frontend_assets/crossbrowserjs/excanvas.min.js"></script>
<![endif]-->
<script src="/frontend_assets/plugins/js-cookie/js.cookie.js"></script>
<script src=" {{ asset("frontend_assets/js/e-commerce/apps.min.js")}}"></script>
<!-- ================== END BASE JS ================== -->
