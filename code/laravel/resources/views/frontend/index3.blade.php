...
<body>
    ...
    <div id="page-title" class="page-title has-bg">
        <div class="bg-cover bottom"><img src="../assets/img/cover/cover-4.jpg" alt="" /></div>
        <div class="container">
                                    ...
                                    <div id="carousel-post" class="carousel slide" data-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="item active">
                                                <a href="post_detail.html"><img src="../assets/img/post/post-1.jpg" alt="" /></a>
                                            </div>
                                            <div class="item">
                                                <a href="post_detail.html"><img src="../assets/img/post/post-2.jpg" alt="" /></a>
                                            </div>
                                            <div class="item">
                                                <a href="post_detail.html"><img src="../assets/img/post/post-3.jpg" alt="" /></a>
                                            </div>
                                        </div>
                                        <!-- end carousel-inner -->
                        ...
                        <li>
                            ...
                            <div class="post-content">
                                ...
                                <div class="post-image">
                                    <a href="post_detail.html"><img src="../assets/img/post/post-4.jpg" alt="" /></a>
                                </div>
                                <!-- end post-image -->
                                <!-- begin post-info -->
                                <div class="post-info">
    ...
    <div class="theme-panel">
        ...
        <div class="theme-panel-content">
            <ul class="theme-list clearfix">
                <li><a href="javascript:;" class="bg-purple" data-theme="purple" data-theme-file="../assets/css/blog/theme/purple.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Purple">&nbsp;</a></li>
                <li><a href="javascript:;" class="bg-blue" data-theme="blue" data-theme-file="../assets/css/blog/theme/blue.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Blue">&nbsp;</a></li>
                <li class="active"><a href="javascript:;" class="bg-green" data-theme-file="../assets/css/blog/theme/default.css" data-theme="default" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Default">&nbsp;</a></li>
                <li><a href="javascript:;" class="bg-orange" data-theme="orange" data-theme-file="../assets/css/blog/theme/orange.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Orange">&nbsp;</a></li>
                <li><a href="javascript:;" class="bg-red" data-theme="red" data-theme-file="../assets/css/blog/theme/red.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Red">&nbsp;</a></li>
            </ul>
        </div>
    </div>
    <!-- end theme-panel -->
