          ...
          <input type="submit" form="altEditor-form" class="btn btn-primary"></input>\
                ...
                _openEditModal : function() {
                  ...
                  for ( var j in columnDefs) {
                    ...
                    if (columnDefs[j].type && columnDefs[j].type.includes("select")) {
                      ...
                      data += "<select class='form-control'>" + options
                          + "</select>";
                    }
             ...
             <button type='button' data-content='remove' class='btn btn-primary' id='editRowBtn'>Submit</button>");
                ...
                _editRowData : function() {
                  ...
                  $('#modal-dialog .modal-body .alert').remove();

                  var message = '<div class="alert alert-success" role="alert">\
        <strong>Success!</strong> This record has been updated.\
        </div>';

                  $('#modal-dialog .modal-body').append(message);
                ...
                _openAddModal : function() {
                  ...
                  for ( var j in columnDefs) { 
                    data += "<div class='form-group'><div class='col-sm-5 col-md-5 col-lg-5 text-right' style='padding-top:4px;'><label for='"
                        ...
                        + "'>"
                        + columnDefs[j].title
                        + ":</label></div><div class='col-sm-6 col-md-6 col-lg-6'>";
...
var undoChanges = function(tableObj) {
  ...
  $('#modal-dialog')
      .on(
          'show.bs.modal',
          function() {
            $('#modal-dialog').find('.modal-title').html('Cancel changes');
            $('#modal-dialog').find('.modal-body').html(
