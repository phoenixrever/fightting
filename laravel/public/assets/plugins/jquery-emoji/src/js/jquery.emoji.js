    ...
    Plugin.prototype = {
        _init: function () {
            ...
            if (!btn) {
                ...
                // $(newBtn).appendTo($('.emoji-box'));
                // console.log(this.$content.closest(".send-box").find(".emoji-box"));
                this.$content.closest(".send-box").find(".emoji-box").prepend(newBtn);
            ...
            $(emoji_container).appendTo(this.$content.closest(".send-box").find(".emoji-container"));
            // calc panel width
            ...
            $(document).on('blur',".plaintext[contenteditable]",function(){
                // console.log($(this).caret('position'));
                // console.log($(this).caret('offset'));
                // pos=$(this).caret('position');
                ...
                'click': function (e) {
                    ...
                    if (target === $(btn)[0]) {
                        ...
                        if($(target).prop('tagName')==="LI"){
                            code = $(target).find("a").data('emoji_code');
                            // console.log("li-----------");
                            // console.log(r);
                        }else if($(target).prop('tagName')==="A"){
                            code=$(target).data('emoji_code');
                            // console.log("A-----------");
                            // console.log(r);
                        }else{
                            code =$(target).parent("a").data('emoji_code');
                            // console.log(r);
                        }
                        ...
                        if (code) {
                            if (field.nodeName === 'DIV') {
                                ...
                                // placeCaretAtEnd(document.getElementById(that.$content.attr("id")));
                            } else {
        ...
        // _insertAtCursor: function (field, value,selectionRange, selectPastedContent) {
        //     var sel, range;
        //     if (field.nodeName === 'DIV') {
        //         // field.focus();
        //         if (window.getSelection) {
