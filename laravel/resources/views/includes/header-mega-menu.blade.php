...
<div class="collapse navbar-collapse pull-left" id="top-navbar">
	<ul class="nav navbar-nav">
		<li class="dropdown dropdown-lg">
			<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-th-large fa-fw"></i> Mega <b class="caret"></b><span class="arrow top"></span></a>
		...
		<li>
			<a href="javascript:;">
				<i class="fa fa-gem fa-fw"></i> Client<span class="arrow top"></span>
			</a>
		</li>
		<li class="dropdown">
			<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
				<i class="fa fa-database fa-fw"></i> New <b class="caret"></b><span class="arrow top"></span>
			</a>
